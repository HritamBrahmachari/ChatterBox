...
export const uploadFile = async (req, res) => {
  try {
    ...
    // Assumes the 'backend/uploads' directory is served statically at '/uploads'
    // You might need to configure static serving in your main server file (e.g., server.js)
